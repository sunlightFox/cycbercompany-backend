    ...
    public ToolExecutionResult uploadIfPresent(String runId, ToolExecutionResult execution) {
        ...
        try {
            ...
            HttpRequest request = HttpRequest.newBuilder(URI.create(endpoint))
                    ...
                    .header("X-Agent-Studio-Run-Id", runId == null ? "" : runId)
                    .header("X-Agent-Studio-Artifact-Type", type)
                    .header("X-Agent-Studio-Filename", artifact.getFileName().toString())
                    .header("X-Agent-Studio-Artifact-Digest", digest)
