...
public final class ServiceTool {
    ...
    private static final String SERVICE_NAME_ENV = "AGENT_STUDIO_SERVICE_NAME";
    private static final String SERVICE_START_MODE_ENV = "AGENT_STUDIO_SERVICE_START_MODE";
    private static final String QUERY_SCRIPT = """
            $ErrorActionPreference = 'Stop'
            $name = $env:AGENT_STUDIO_SERVICE_NAME
    ...
    private static final String SET_START_MODE_SCRIPT = """
            $ErrorActionPreference = 'Stop'
            $name = $env:AGENT_STUDIO_SERVICE_NAME
            $mode = $env:AGENT_STUDIO_SERVICE_START_MODE
