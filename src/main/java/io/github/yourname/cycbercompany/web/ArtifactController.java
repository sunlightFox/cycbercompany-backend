...
import io.github.yourname.cycbercompany.artifact.ArtifactDownload;
import io.github.yourname.cycbercompany.artifact.ArtifactService;
import io.github.yourname.cycbercompany.node.NodeConnectionEntity;
...
public class ArtifactController {
    ...
    private static final String NODE_ID = "X-CycberCompany-Node-Id";
    private static final String RUN_ID = "X-CycberCompany-Run-Id";
    private static final String ARTIFACT_TYPE = "X-CycberCompany-Artifact-Type";
    private static final String FILENAME = "X-CycberCompany-Filename";
    private static final String DIGEST = "X-CycberCompany-Artifact-Digest";
