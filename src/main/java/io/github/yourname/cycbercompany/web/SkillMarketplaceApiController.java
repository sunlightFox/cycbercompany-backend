...
import io.github.yourname.cycbercompany.skill.SkillMarketplaceService;
import io.github.yourname.cycbercompany.skill.SkillMarketplaceView;
import io.github.yourname.cycbercompany.skill.InstallSkillHubSkillCommand;
...
class SkillMarketplaceApiController {
    ...
    Object installSkillHub(@Valid @org.springframework.web.bind.annotation.RequestBody InstallSkillHubSkillCommand command) {
        ...
        return skills.installClawHub(new io.github.yourname.cycbercompany.skill.InstallClawHubSkillCommand(
