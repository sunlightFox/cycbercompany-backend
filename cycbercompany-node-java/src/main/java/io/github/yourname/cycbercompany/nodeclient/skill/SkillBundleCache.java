...
public final class SkillBundleCache {
    ...
    public static final String RELEASE_DIGEST_HEADER = "X-CycberCompany-Release-Digest";
    public static final String BUNDLE_DIGEST_HEADER = "X-CycberCompany-Bundle-Digest";
